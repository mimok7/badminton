    ...
    try {
      ...
      matches?.forEach((match: any) => {
        ...
        const team1_player1 = Array.isArray(match.team1_player1) 
          ? match.team1_player1[0] as unknown as ProfileData
          : match.team1_player1 as unknown as ProfileData;
        const team1_player2 = Array.isArray(match.team1_player2) 
          ? match.team1_player2[0] as unknown as ProfileData
          : match.team1_player2 as unknown as ProfileData;
        const team2_player1 = Array.isArray(match.team2_player1) 
          ? match.team2_player1[0] as unknown as ProfileData
          : match.team2_player1 as unknown as ProfileData;
        const team2_player2 = Array.isArray(match.team2_player2) 
          ? match.team2_player2[0] as unknown as ProfileData
          : match.team2_player2 as unknown as ProfileData;
  ...
  const searchOpponent = async () => {
    ...
    try {
      ...
      for (const opponent of searchProfiles || []) {
        ...
        if (totalMatches > 0) {
          opponentStats.push({
            opponentName: opponent.full_name || opponent.username || '이름 없음',
