...
export default function MatchAssignmentLayout({ children }: { children: React.ReactNode }) {
    ...
    <div className="min-h-screen grid grid-cols-[16rem_1fr] bg-gray-50">
      <aside className="w-64 shrink-0 border-r border-gray-200 bg-white sticky top-0 h-screen overflow-y-auto z-30">
        <div className="p-6 border-b border-gray-100">
          <Link href="/" className="block text-lg font-semibold text-gray-900">메뉴</Link>
          <div className="mt-1 text-sm text-gray-500">빠른 이동</div>
        </div>
